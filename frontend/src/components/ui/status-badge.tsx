...
export type StatusType = string | boolean | null;
...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  planned: { label: "Planned", className: "bg-stone-100 text-stone-600 border-stone-200" },
  dispatched: { label: "Dispatched", className: "bg-blue-100 text-blue-700 border-blue-200" },
  retry_wait: { label: "Retry wait", className: "bg-orange-100 text-orange-700 border-orange-200" },
